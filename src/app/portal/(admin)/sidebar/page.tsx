...
import AddSidebarItem from "@/components/modals/add-sidebar-item";
...
export default function Sidebar({ apiUrl = "sidebar-items" }) {
  // ? States
  ...
  const {
    ...
    columnsToSort: [{ field: "priority", sort: "asc" }],
    toPin: {
      left: ["id", "priority"],
      right: ["isExpanded", "isVisible", "actions"],
    },
  });
  ...
  const { data, isLoading } = useQuery({
    ...
    select: ({
      ...
      data: DataGridApiResponse & { dataset: Prisma.SidebarLinksModel[] };
    }) => data,
    ...
    <div className="flex flex-1">
      ...
      <DataGridPro
        ...
        onRowOrderChange={(params: GridRowOrderChangeParams) => {
          const rowsClone = [...(data?.dataset as Prisma.SidebarLinksModel[])];
