...
export default function CreateStore({
  ...
  return (
    <Fragment>
      ...
      <Dialog open={isNewItemOpen} onOpenChange={onOpenChange}>
        <DialogContent className="bg-sidebar">
          <DialogHeader>
            <DialogTitle className="text-primary">Create Store</DialogTitle>
            <DialogDescription>
                  ...
                  render={() => (
                    ...
                    >
                      {[
                        ...
                        <FieldLabel key={key} htmlFor={value} className="w-1/2">
